export const SaturnSvg = () => {
  return (
    ...
    width="300"
    height="300"
    xmlns="http://www.w3.org/2000/svg" xmlnsXlink="http://www.w3.org/1999/xlink" version="1.1" viewBox="0 0 300 300">
  <defs>
    <linearGradient id="gradation_saturn" data-name="gradation_saturn 722" x1="3.9" y1="150.4" x2="290.3" y2="150.4" gradientUnits="userSpaceOnUse">
  ...
  <g>
    <g id="_レイヤー_2" data-name="レイヤー_2">
      <g>
        ...
        <path d="M216.8,104.9c1.4,2.2,3.2,4.6,4.4,7,10.1-1,16.7-1.2,17.7,1.7,1,2.9-3.2,7.4-11.4,12.8-15,10-43.1,23-76.3,34.7-29.5,10.4-56.5,17.4-74.7,20-13.5,1.9-22.2,1.4-23.4-2.1s5.2-9.1,17.3-16.2c-.3-4.3-.3-3.7-.4-7.8C28.2,174.1,1.1,192.1,4.1,200.5c3,8.5,35,5.6,79.8-5.8,21.4-5.4,45.7-12.8,71.2-21.8,28.3-10,54.2-20.5,75.6-30.6,38.4-18.1,62.3-34.4,59.4-42.5-2.8-8-32.3-4.8-73.3,5.1Z" fill="url(#gradation_saturn)"/>
      </g>
    </g>
  </g>
</svg>
